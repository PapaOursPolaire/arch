...
readonly LOCKSCREEN_THEME_DIR="/usr/share/plasma/look-and-feel/org.kde.falloutlock" # Ne fonctionne pas car je n'ai pas trouvé delockscreen digne de la license fallout, ceci est un exemple
